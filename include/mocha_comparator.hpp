...
public:
  ...
  std::function<bool(T, U)> strict_equal = [&] (T a, U b) -> bool { return strict_equal_(a, b); };


private:
  // Universal comparison of same type
  inline bool strict_equal_(T a, T b) { return a == b; }
  inline bool equal_(T a, T b) { return a == b; }
